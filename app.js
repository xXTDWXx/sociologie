...
const auditCoverageMc = [
  ["01", "basis", "Wat bedoelt de cursus met determinanten van gezondheid?", ["Persoonlijke meningen over gezondheid.", "Factoren of elementen die gezondheid beïnvloeden.", "Alleen erfelijke kenmerken.", "Alleen medische diagnoses."], 1, "Determinanten zijn factoren die gezondheid mee bepalen; de cursus bekijkt die op micro-, meso- en macroniveau."],
  ["01", "toepassing", "Wat illustreert de casus van Charlotte, Wim en Lieve doorheen de cursus?", ["Dat gezinnen losstaan van samenleving.", "Dat ouderschap, opvoeding en keuzes sociaal en institutioneel ingebed zijn.", "Dat alleen individuele persoonlijkheid telt.", "Dat sociologie geen toepassing heeft op dagelijks leven."], 1, "De casus toont hoe gezinsleven samenhangt met normen, rollen, instituties, klasse en socialisatie."],
  ["01", "inzicht", "Waarom is lawaai maken op een begrafenis sociologisch interessant?", ["Omdat het altijd strafbaar is.", "Omdat het toont hoe cultuur en context bepalen welk gedrag passend is.", "Omdat begrafenissen geen sociale regels hebben.", "Omdat emoties nooit sociaal zijn."], 1, "De cursus gebruikt dit soort voorbeelden om te tonen dat gedrag betekenis krijgt binnen culturele verwachtingen."],
  ["02", "basis", "Wat is een statusset?", ["Het geheel van statussen verbonden aan iemands sociale posities.", "Het geheel van waarden in een cultuur.", "Het geheel van formele organisaties.", "Het geheel van sancties bij deviantie."], 0, "Omdat mensen meerdere posities hebben, hebben ze ook meerdere statussen."],
  ["02", "inzicht", "Waarom gebruikt de cursus het Nacirema-voorbeeld?", ["Om een vreemde stam exotisch te beoordelen.", "Om te tonen dat eigen vertrouwde gewoontes vreemd lijken wanneer je ze van buitenaf bekijkt.", "Om economische ongelijkheid te meten.", "Om Mertons theorie uit te leggen."], 1, "Nacirema laat zien dat cultuur betekenisgeving is en dat vertrouwd gedrag sociologisch bevraagd kan worden."],
  ["02", "basis", "Wat is een doeleinde binnen de normatieve component van cultuur?", ["Een concrete uitwerking van een waarde in iets dat men wil bereiken.", "Een spontaan biologisch gedrag.", "Een sociale positie.", "Een statusobject."], 0, "Doeleinden maken abstracte waarden concreter en vaak meetbaar."],
  ["02", "basis", "Welke Hofstede-dimensie gaat over gerichtheid op toekomst, volharding en lange termijn?", ["Langetermijngerichtheid tegenover kortetermijngerichtheid", "Machtsafstand", "Masculiniteit", "Toegeeflijkheid"], 0, "Deze dimensie gaat over de tijdshorizon van een cultuur."],
  ["02", "inzicht", "Wat is het verschil tussen de ijsbergmetafoor en de ui-metafoor van cultuur?", ["Beide helpen zien dat zichtbaar gedrag verbonden is met diepere betekenislagen.", "De ijsberg gaat alleen over economie en de ui alleen over recht.", "Ze tonen dat cultuur volledig zichtbaar is.", "Ze bewijzen dat normen biologisch zijn."], 0, "Beide metaforen maken duidelijk dat de zichtbare buitenkant rust op diepere lagen van waarden, normen en overtuigingen."],
  ["03", "basis", "Welke maatschappelijke behoefte hoort bij de institutie recht in de tabel van de cursus?", ["Seksueel contact en sociale controle helpen regelen.", "Alleen voedselproductie.", "Alleen primaire socialisatie.", "Alleen vrije tijd."], 0, "Recht regelt onder meer seksuele afspraken en sociale controle."],
  ["03", "basis", "Welke reeks bevat universele aspecten die instituties helpen regelen?", ["Voortplanting, seksueel contact, zorg en welzijn, socialisatie, opvoeding, zingeving, macht, productie/distributie/consumptie en sociale controle.", "Alleen gezin, school en werk.", "Alleen waarden en normen.", "Alleen status en rolconflict."], 0, "De cursus somt deze basisaspecten op als terugkerende maatschappelijke noden."],
  ["03", "basis", "Wat is geïnstitutionaliseerde zorg?", ["Zorg die vorm krijgt via organisaties en vaste regelingen.", "Zorg die enkel spontaan binnen vrienden gebeurt.", "Een vorm van statusinconsistentie.", "Een soort tegencultuur."], 0, "Zorg krijgt institutioneel vorm via ziekenhuizen, OCMW, CAW en andere organisaties."],
  ["03", "inzicht", "Waarom zijn sociale grondrechten relevant in het hoofdstuk instituties?", ["Ze tonen hoe basisbehoeften maatschappelijk en juridisch geregeld worden.", "Ze bewijzen dat gezin universeel hetzelfde is.", "Ze vervangen socialisatie.", "Ze gaan alleen over subculturen."], 0, "Sociale grondrechten tonen hoe arbeid, sociale zekerheid, behoorlijke huisvesting, gezondheid en onderwijs institutioneel beschermd worden."],
  ["04", "basis", "Waarom is een harmonische sociale context belangrijk bij Mead?", ["Omdat een stabiele en begrijpelijke sociale omgeving helpt om een samenhangende Self te ontwikkelen.", "Omdat socialisatie dan stopt.", "Omdat de I verdwijnt.", "Omdat normen dan biologisch worden."], 0, "Mead benadrukt dat zelfbewustzijn sociaal ontstaat; chaotische of tegenstrijdige contexten kunnen dat bemoeilijken."],
  ["04", "basis", "Wat is sociaal kapitaal in de onderwijscontext?", ["Netwerken, relaties en steun die kansen kunnen vergroten.", "Alleen geld op een spaarrekening.", "Alleen aangeboren intelligentie.", "Een formele straf."], 0, "Sociaal kapitaal verwijst naar relaties en netwerken die hulpbronnen bieden."],
  ["04", "basis", "Welke uitspraak past bij economisch kapitaal?", ["Materiële en financiële middelen die kansen beïnvloeden.", "Alleen taalvaardigheid.", "Alleen vriendenkringen.", "Alleen een innerlijk schuldgevoel."], 0, "Economisch kapitaal gaat over materiële middelen zoals inkomen, bezit en financiële ruimte."],
  ["04", "inzicht", "Waarom verwijst de cursus naar 'Lieve jongens, stoere meisjes'?", ["Om kritisch na te denken over genderspecifieke socialisatie.", "Om Merton uit te leggen.", "Om instituties te definiëren.", "Om sociale controle via politie te tonen."], 0, "De verwijzing past in het debat over gender, opvoeding, verwachtingen en socialisatie."],
  ["05", "inzicht", "Waarom is Marx relevant in het hoofdstuk deviantie?", ["Omdat hij wijst op macht en belangen bij wetgeving en bestraffing.", "Omdat hij socialisatie in het gezin verklaart.", "Omdat hij Hofstede aanvult.", "Omdat hij alleen biologische kenmerken onderzoekt."], 0, "De cursus verwijst naar Marx om te tonen dat wetten en controle ook machtsverhoudingen weerspiegelen."],
  ["05", "basis", "Wat bedoelt de cursus met de signaalfunctie van deviant gedrag?", ["Deviantie kan wijzen op onderliggende maatschappelijke problemen of regels die niet meer passen.", "Deviantie is altijd nutteloos.", "Deviantie betekent altijd ziekte.", "Deviantie vervangt socialisatie."], 0, "Afwijkend gedrag kan signaleren dat er iets wringt in regels, voorzieningen of maatschappelijke verhoudingen."],
  ["05", "inzicht", "Waarom past Rosa Parks in het hoofdstuk deviantie?", ["Haar normovertreding toont dat deviantie kan bijdragen tot maatschappelijke verandering.", "Ze illustreert statusconsistentie.", "Ze verklaart primaire socialisatie.", "Ze toont dat regels nooit veranderen."], 0, "Burgerlijke ongehoorzaamheid kan aanvankelijk deviant lijken maar later als motor van rechtvaardige verandering worden gezien."],
  ["05", "basis", "Wat is het verschil tussen primair deviant en secundair deviant gedrag?", ["Primair is de eerste afwijkende handeling; secundair ontstaat als reactie op label, stigma of gevolgen.", "Primair is juridisch, secundair biologisch.", "Primair is positief, secundair is altijd positief.", "Er is geen verschil."], 0, "Dit onderscheid is belangrijk bij Becker en labeling."],
  ["05", "basis", "Wat zijn dysfunctionele gevolgen van deviant gedrag?", ["Negatieve gevolgen die vertrouwen, veiligheid of organisatie verstoren.", "Altijd positieve effecten voor solidariteit.", "Alleen culturele waarden.", "Een vorm van participatief opvoeden."], 0, "Dysfunctioneel verwijst naar gevolgen die samenleven of organisaties onder druk zetten."],
  ["05", "basis", "Welke omschrijving past bij biologische verklaringsmodellen voor deviantie?", ["Ze zoeken oorzaken in lichamelijke, erfelijke of biologische kenmerken.", "Ze kijken vooral naar labeling.", "Ze verklaren alles via sociale rollen.", "Ze gaan over cultuurpluralisme."], 0, "De cursus behandelt biologische modellen kritisch omdat ze context kunnen onderschatten."],
  ["05", "basis", "Welke omschrijving past bij psychologische verklaringsmodellen voor deviantie?", ["Ze zoeken oorzaken in persoonlijkheid of psychische processen.", "Ze verklaren alles via machtsafstand.", "Ze gaan over statussymbolen.", "Ze beschrijven alleen instituties."], 0, "Psychologische verklaringen leggen de nadruk op het individu en worden sociologisch aangevuld met context."],
];

const auditCoverageOpen = [
  ["01", "toepassing", "Leg de toepassing rond Charlotte, Wim en Lieve uit als voorbeeld van sociologisch kijken naar gezinsleven.", "De casus toont dat gezinsleven niet losstaat van samenleving. Ouderschap, kinderopvang, werk, sociaaljuridische regels, klassepositie en culturele verwachtingen beïnvloeden hoe Wim en Lieve hun ouderrol invullen. Sociologisch kijken betekent dat je hun keuzes niet alleen persoonlijk verklaart, maar verbindt met structuur, cultuur en instituties.", ["Je noemt Charlotte/Wim/Lieve.", "Je gebruikt structuur/cultuur/instituties.", "Je vermijdt puur individuele verklaring."]],
  ["02", "examen", "Leg de Nacirema-illustratie uit. Wat leert ze over cultuur en sociologische afstand?", "De Nacirema-tekst beschrijft vertrouwde lichaams- en gezondheidsrituelen alsof ze vreemd zijn. Daardoor merk je dat ook eigen gewoontes cultureel bepaald zijn. De illustratie leert dat sociologie afstand neemt van vanzelfsprekendheden en vraagt welke betekenissen, waarden en normen achter gedrag zitten.", ["Je legt het doel van Nacirema uit.", "Je verbindt met betekenisgeving.", "Je noemt sociologische afstand of vanzelfsprekendheden."]],
  ["02", "examen", "Bespreek de gradaties in normen: gewoonten, mores, wetten en taboes.", "Normen verschillen in zwaarte. Gewoonten of gebruiken regelen alledaags gedrag en leiden bij overtreding vaak tot lichte afkeuring. Mores zijn zwaarder moreel geladen. Wetten zijn formeel vastgelegd en juridisch afdwingbaar. Taboes zijn zeer sterke normen waarvan overtreding zware afkeuring oproept, zoals incest of kindermishandeling.", ["Je noemt meerdere normgradaties.", "Je legt verschil in zwaarte uit.", "Je geeft voorbeelden."]],
  ["02", "examen", "Bespreek alle zes cultuurdimensies van Hofstede en formuleer waarom voorzichtigheid nodig is.", "De dimensies zijn machtsafstand, individualisme versus collectivisme, masculien versus feminien, onzekerheidsvermijding, langetermijn- versus kortetermijngerichtheid en toegeeflijkheid versus terughoudendheid. Ze helpen cultuurverschillen ordenen, maar moeten voorzichtig gebruikt worden omdat er binnen culturen veel diversiteit bestaat en omdat individuen niet gereduceerd mogen worden tot nationale gemiddelden.", ["Je noemt de zes dimensies.", "Je legt het nut uit.", "Je formuleert een kritische bedenking."]],
  ["03", "examen", "Som de universele aspecten van het menselijk bestaan op die instituties volgens de cursus helpen regelen.", "De cursus noemt voortplanting, seksueel contact, zorg en welzijn, socialisatie, opvoeding, zingeving, verdeling van macht, productie/distributie/consumptie van goederen en sociale controle. Instituties geven aan elk van deze terugkerende behoeften vaste patronen en concrete organisaties.", ["Je noemt minstens zeven aspecten.", "Je legt het verband met instituties.", "Je noemt concrete organisaties of patronen."]],
  ["03", "examen", "Bespreek monogamie, seriële monogamie, polygamie en incesttaboe als voorbeelden van institutionele regeling van seksualiteit.", "Monogamie betekent dat één partner tegelijk toegestaan is. Seriële monogamie verwijst naar opeenvolgende monogame relaties doorheen de levensloop. Polygamie betekent dat meerdere partners toegestaan zijn. Het incesttaboe is een bijna universele regeling die seksuele relaties tussen nauwe verwanten verbiedt. Deze voorbeelden tonen dat seksualiteit sociaal en cultureel geregeld wordt.", ["Je legt alle begrippen uit.", "Je verbindt met gezin/familie als institutie.", "Je toont dat seksualiteit sociaal geregeld wordt."]],
  ["03", "examen", "Leg sociale grondrechten uit binnen het hoofdstuk instituties.", "Sociale grondrechten tonen hoe basisbehoeften maatschappelijk erkend en geregeld worden, bijvoorbeeld recht op arbeid, sociale zekerheid, behoorlijke huisvesting, gezondheid, sociale en geneeskundige bijstand, onderwijs en culturele/maatschappelijke ontplooiing. Ze maken duidelijk dat welzijn niet alleen privé is, maar institutioneel ondersteund wordt.", ["Je benoemt sociale grondrechten.", "Je geeft voorbeelden.", "Je verbindt met instituties/welvaartsstaat."]],
  ["04", "examen", "Leg het belang uit van een harmonische sociale context voor de ontwikkeling van Self, I en Me.", "Bij Mead ontstaat het zelf in sociale interactie. Een harmonische sociale context geeft voldoende stabiele, begrijpelijke en samenhangende verwachtingen zodat iemand zichzelf kan leren bekijken vanuit anderen. Wanneer de context chaotisch of tegenstrijdig is, kan het moeilijker worden om een stabiel zelfbeeld en passende role-taking te ontwikkelen.", ["Je verbindt met Mead.", "Je legt harmonische context uit.", "Je benoemt gevolgen van chaos/tegenstrijdigheid."]],
  ["04", "examen", "Vergelijk economisch, sociaal en cultureel kapitaal en verbind ze met onderwijskansen.", "Economisch kapitaal zijn financiële en materiële middelen. Sociaal kapitaal zijn netwerken, relaties en steun. Cultureel kapitaal zijn kennis, taal, houdingen en culturele codes die aansluiten bij instituties zoals school. Kinderen beschikken hier niet in gelijke mate over, waardoor onderwijs formeel gelijk kan zijn maar toch ongelijkheid reproduceert.", ["Je definieert drie kapitalen.", "Je verbindt met school.", "Je legt ongelijkheid/reproductie uit."]],
  ["05", "examen", "Leg uit hoe Marx helpt om de relatie tussen deviantie, wet en macht te begrijpen.", "Marx helpt zien dat wetgeving en sociale controle niet neutraal hoeven te zijn. De groepen met macht kunnen mee bepalen welke gedragingen als bedreigend, strafbaar of deviant worden gezien. Daardoor worden overtredingen van machtelozere groepen soms sneller zichtbaar en bestraft dan schadelijk gedrag van machtigere groepen.", ["Je noemt macht/belangen.", "Je verbindt met wetgeving of bestraffing.", "Je past toe op ongelijke labeling."]],
  ["05", "examen", "Bespreek functionele én dysfunctionele gevolgen van deviant gedrag, inclusief signaalfunctie en Rosa Parks.", "Dysfunctionele gevolgen zijn negatieve effecten zoals onveiligheid, verlies van vertrouwen of verstoring van organisatie. Functionele gevolgen kunnen zijn dat normen verduidelijkt worden, solidariteit groeit, regels flexibel worden toegepast of maatschappelijke problemen zichtbaar worden. Deviantie kan een signaalfunctie hebben: ze wijst op regels of omstandigheden die niet werken. Rosa Parks illustreert dat normovertreding kan bijdragen aan maatschappelijke verandering.", ["Je bespreekt dysfunctioneel.", "Je bespreekt functioneel.", "Je noemt signaalfunctie.", "Je gebruikt Rosa Parks of maatschappelijke verandering."]],
  ["05", "examen", "Vergelijk biologische, psychologische en sociologische verklaringsmodellen voor deviant gedrag.", "Biologische verklaringen zoeken oorzaken in lichamelijke of erfelijke kenmerken. Psychologische verklaringen zoeken oorzaken in persoonlijkheid, trauma of psychische processen. Sociologische verklaringen kijken naar organisatie van de samenleving, kansenstructuur, machtsverhoudingen, subculturen, sociale bindingen en labeling. De cursus behandelt individuele verklaringen kritisch omdat ze sociale context kunnen onderschatten.", ["Je bespreekt biologische verklaring.", "Je bespreekt psychologische verklaring.", "Je bespreekt sociologische verklaring.", "Je formuleert de kritiek."]],
];

const auditCoverageCases = [
  ["02", "toepassing", "Een student vindt de Nacirema-tekst belachelijk en zegt: 'Zo vreemd zijn wij toch niet.'", "Hoe reageer je sociologisch?", "Je legt uit dat Nacirema net bedoeld is om vertrouwde rituelen vreemd te maken. Door afstand te nemen van eigen vanzelfsprekendheden zie je dat ook onze lichaamszorg, gezondheid en schoonheid cultureel betekenisvol zijn. De sociologische reactie is dus niet lachen met de ander, maar jezelf leren analyseren.", ["Je begrijpt het doel van Nacirema.", "Je verbindt met cultuur.", "Je vermijdt etnocentrisme."]],
  ["03", "toepassing", "Een cliënt heeft geen toegang tot degelijke huisvesting en zorg. Hij zegt: 'Dat is mijn privéprobleem.'", "Analyseer dit met sociale grondrechten en instituties.", "Huisvesting en zorg zijn niet alleen privézaken; ze zijn maatschappelijk en institutioneel geregeld. Sociale grondrechten tonen dat de samenleving bepaalde basisbehoeften erkent. Een sociaal werker kijkt daarom naar voorzieningen, rechten, organisaties en beleid, niet alleen naar individuele keuzes.", ["Je gebruikt sociale grondrechten.", "Je noemt instituties/organisaties.", "Je nuanceert privéprobleem."]],
  ["04", "toepassing", "Een jongere krijgt thuis, op school en online heel tegenstrijdige verwachtingen over gender, succes en gehoorzaamheid.", "Analyseer dit met harmonische sociale context en differentiële socialisatie.", "De jongere wordt in verschillende contexten gesocialiseerd en krijgt mogelijk tegenstrijdige lessen. Bij Mead kan een chaotische of tegenstrijdige sociale context het ontwikkelen van een stabiele Self bemoeilijken. Differentiële socialisatie toont dat lessen verschillen naargelang gender, klasse en omgeving.", ["Je gebruikt harmonische sociale context.", "Je gebruikt differentiële socialisatie.", "Je past toe op meerdere contexten."]],
  ["05", "toepassing", "Een groep jongeren overtreedt een pleinverbod omdat er nergens veilige vrijetijdsruimte is. De buurt klaagt over overlast.", "Analyseer dit met dysfunctionele gevolgen, signaalfunctie en sociaal werk.", "De overlast kan dysfunctionele gevolgen hebben voor buurtveiligheid en vertrouwen. Tegelijk kan het gedrag een signaalfunctie hebben: er is misschien te weinig veilige vrijetijdsruimte. Sociaal werk moet daarom zowel grenzen en leefbaarheid erkennen als de achterliggende maatschappelijke nood zichtbaar maken.", ["Je benoemt dysfunctionele gevolgen.", "Je benoemt signaalfunctie.", "Je verbindt met sociaal werk."]],
];

questionBank.push(
  ...auditCoverageMc.map(([chapter, difficulty, prompt, options, answer, explanation], index) => ({
    id: `audit-mc-${String(index + 1).padStart(3, "0")}`,
    chapter,
    type: "mc",
    difficulty,
    prompt,
  ...
  ...auditCoverageOpen.map(([chapter, difficulty, prompt, model, rubric], index) => ({
    id: `audit-open-${String(index + 1).padStart(3, "0")}`,
    chapter,
    type: "open",
    difficulty,
    prompt,
  ...
  ...auditCoverageCases.map(([chapter, difficulty, caseText, prompt, model, rubric], index) => ({
    id: `audit-case-${String(index + 1).padStart(3, "0")}`,
    chapter,
    type: "case",
    difficulty,
    case: caseText,
